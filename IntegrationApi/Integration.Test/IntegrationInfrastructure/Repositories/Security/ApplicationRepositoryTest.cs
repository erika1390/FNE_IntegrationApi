...
namespace Integration.Test.Integration.Infrastructure.Repositories.Security
{
    [TestFixture]
    public class ApplicationRepositoryTest
    {
        ...
        {
            // Arrange
            var application = new Application { Id = 1, Name = "App1", IsActive = true };
            _mock.Setup(repo => repo.GetByIdAsync(1))
        ...
        public async Task GetAllAsync_WithPredicate_ShouldReturnFilteredApplications()
        {
            ...
            {
                new Application { Id = 1, Name = "App1", IsActive = true },
                new Application { Id = 2, Name = "App2", IsActive = false }
            };
        ...
        public async Task GetAllActiveAsync_ShouldReturnActiveApplications()
        {
            ...
            {
                new Application { Id = 1, Name = "App1", IsActive = true },
                new Application { Id = 2, Name = "App2", IsActive = true }
            };
