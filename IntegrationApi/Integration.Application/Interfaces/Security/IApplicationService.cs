...
namespace Integration.Application.Interfaces.Security
{
    public interface IApplicationService
    {
        ...
        Task<List<ApplicationDTO>> GetAllAsync(Expression<Func<ApplicationDTO, bool>> predicate);
        Task<List<ApplicationDTO>> GetAllAsync(List<Expression<Func<ApplicationDTO, bool>>> predicates);
