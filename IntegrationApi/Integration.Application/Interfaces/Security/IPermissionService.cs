...
namespace Integration.Application.Interfaces.Security
{
    public interface IPermissionService
    {
        ...
        Task<List<PermissionDTO>> GetAllAsync(Expression<Func<PermissionDTO, bool>> predicate);
        Task<List<PermissionDTO>> GetAllAsync(List<Expression<Func<PermissionDTO, bool>>> predicates);
