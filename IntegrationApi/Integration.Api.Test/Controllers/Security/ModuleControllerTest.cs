...
namespace Integration.Api.Test.Controllers.Security
{
    ...
    public class ModuleControllerTest
    {
        ...
        public async Task GetAllActive_ShouldReturnOk_WhenModulesExist()
        {
            ...
            {
                new ModuleDTO { Code = "MOD0000001", Name = "Aplicaciones", IsActive = true, CreatedBy="epulido" }
            };
        ...
        public async Task GetByCode_ShouldReturnOk_WhenModuleExists()
        {
            // Arrange
            var header = new HeaderDTO { ApplicationCode = "APP0000001", UserCode = "USR0000001" };
            var module = new ModuleDTO { Code = "MOD0000001", Name = "Aplicaciones", IsActive = true, CreatedBy = "epulido" };
